export default function init(t, r, d) {
  const target = t;
  function i(e, t) {}
  function n(e) {
  ...
  return (
    (c.SystemInfo = (function () {
      ...
      var gl = target.getContext('webgl2') || target.getContext('webgl');
      var hasWebGL = target.getContext('webgl2')
        ? 2
        : target.getContext('webgl')
        ? 1
        : 0;
      var ext = gl.getExtension('WEBGL_debug_renderer_info');
      var n = gl.getParameter(37446) || gl.getParameter(7937) || null;
      var hasThreads = 'undefined' != typeof SharedArrayBuffer;
      var u =
          {
            'NT 5.0': '2000',
            'NT 5.1': 'XP',
